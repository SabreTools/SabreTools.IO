...
namespace SabreTools.IO.Compression.Deflate
{
    ...
    ///   <c>SabreTools.IO.Compression.Deflate.GZipStream</c> can compress while writing, or decompress while
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        ///     {
        ///         using (Stream decompressor= new SabreTools.IO.Compression.Deflate.GZipStream(input, CompressionMode.Decompress, true))
        ///         {
        ...
        ///         Using decompressor As Stream = new SabreTools.IO.Compression.Deflate.GZipStream(input, CompressionMode.Decompress, True)
        ...
        {
            if (_disposed) throw new ObjectDisposedException("GZipStream");
            if (_baseStream._streamMode == SabreTools.IO.Compression.Deflate.ZlibBaseStream.StreamMode.Undefined)
            {
